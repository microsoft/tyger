...
public static partial class LoggerExtensions
{
    ...
    [LoggerMessage(14, LogLevel.Information, "Executed Kubernetes API request {method} {uri}. Status code {statusCode}. Duration {milliseconds}ms. {errorBody}")]
    public static partial void ExecutedKubernetesRequest(this ILogger logger, HttpMethod method, string? uri, int statusCode, long milliseconds, string? errorBody);
}
