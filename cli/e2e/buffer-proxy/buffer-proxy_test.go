...
func TestReadingWhileWriting(t *testing.T) {
	...
	bufferName := e2e.RunTygerSuceeds(t, "buffer", "create")
	writeSasUri := e2e.RunTygerSuceeds(t, "buffer", "access", bufferName, "--write")
	readSasUri := e2e.RunTygerSuceeds(t, "buffer", "access", bufferName)
