...
cloud:
  ...
  # instead of the public sources. Useful when policy forbids cluster image pulls from
  # public registries. Can be a short name (e.g. "myacr") or a fully-qualified name (e.g. "myacr.azurecr.io").
  # When containerRegistryMirror is set, image values for individual Helm chart configs can be excluded with excludeFromContainerRegistryMirror.
