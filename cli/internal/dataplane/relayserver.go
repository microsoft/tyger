...
func RelayInputServer(
	...
	return relayServer(ctx, listeners, addRoutes)
}
...
func relayServer(ctx context.Context, listeners []net.Listener, addHandlers func(mux *chi.Mux, transferComplete context.CancelFunc)) error {
