...
sed -i "s/${image_digest_pattern}/${escaped_digest_reference}/" "${this_dir}/devcontainer.json" "${this_dir}/../azure-pipelines.yml" "${this_dir}/../build/delete-pr-environments.yml"
